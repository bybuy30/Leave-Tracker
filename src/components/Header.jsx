      ...
      <div className="px-6 py-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex-shrink-0">
            <h1 className="text-2xl font-bold text-white">Expat Global Tax</h1>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="px-4 py-2 text-sm font-medium text-white hover:bg-gray-800 rounded-lg transition-colors flex flex-col items-center leading-tight">
              <span>Leave</span>
              <span>Tracker</span>
            </button>
            <button
              onClick={handleLogout}
              className="inline-flex items-center gap-2 px-4 py-2 hover:bg-red-700 text-white rounded-lg font-semibold transition-colors"
              title="Logout"
            >
